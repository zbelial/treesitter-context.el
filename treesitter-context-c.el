...
(defconst treesitter-context--c-node-types '("preproc_if" "preproc_ifdef" "function_definition" "for_statement" "if_statement" "else_clause" "while_statement" "do_statement" "struct_specifier" "enum_specifier" "switch_statement" "case_statement")
...
(defconst treesitter-context--c-query
  '(
    ...
    (case_statement value: (identifier) :anchor) @context
